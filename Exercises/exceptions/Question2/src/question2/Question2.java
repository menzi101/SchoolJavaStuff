...
public class Question2 {
 ...
 /**
    ...
    public static void main(String[] args) {
            // Area of a circle
    System.out.printf("The area of a circle with a " + "radius of 10.0 is %6.2f\n", Question2.getArea(10.0));

            // Area of a rectangle
    System.out.printf("The area of a rectangle with a " + "length of 15 and a width of 25 is %6.2f\n", Question2.getArea(15, 25));

            // Area of cylinder
    System.out.printf("The area of a cylinder with a " + "radius of 12.0 and a height " + "of 17.0 is %6.2f\n", Question2.getArea(12.0, 17.0));
    }
